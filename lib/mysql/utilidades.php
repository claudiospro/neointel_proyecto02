...
class Utilidades {
    ...
    static function fechas_de_MysqlTimeStamp_a_string_hm($f) {
        $out = '';
        if ( strlen($f) == 19 ) {
            $out = substr($f, 0, -3);
        }
    ...
    static function printr($in) {
        echo '<pre style="border: 1px solid; margin-bottom: 10px; background-color: rgb(196, 196, 196); height: 300px;">';
        print_r($in);
        echo '</pre>';
    }
