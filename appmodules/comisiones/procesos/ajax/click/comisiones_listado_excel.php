...
function imprimir($index, $i, $titulo, $fibra, $movil) {
    ...
    $objPHPExcel->setActiveSheetIndex($index)
        ...
        ->setCellValue(c1(6,$i), '')
        ->setCellValue(c1(7,$i), $total_1)->mergeCells(c2(7,7,$i,$i+2))
        ->setCellValue(c1(8,$i), count($movil['residencial']['S']))->mergeCells(c2(8,8,$i,$i+2))
        ->setCellValue(c1(9,$i), '')->mergeCells(c2(9,9,$i,$i+2))
        ->setCellValue(c1(10,$i), count($movil['residencial']['M']))->mergeCells(c2(10,10,$i,$i+2))
        ->setCellValue(c1(11,$i), '')->mergeCells(c2(11,11,$i,$i+2))
        ->setCellValue(c1(12,$i), count($movil['residencial']['L']))->mergeCells(c2(12,12,$i,$i+2))
        ->setCellValue(c1(13,$i), '')->mergeCells(c2(13,13,$i,$i+2))
        ->setCellValue(c1(14,$i), $total_2)->mergeCells(c2(14,14,$i,$i+2))
