...
function imprimir($index, $i, $titulo, $fibra, $movil) {
    ...
    global $border_style;
        ...
        $total_1 = count($fibra['residencial']['2P']['300MB']) 
                 ...
                 + count($fibra['residencial']['2P']['adsl'])
                 + count($fibra['residencial']['3P']['adsl'])
                 ;
