...
if (isset($ou))
{
    ...
    foreach($ou as $row )
    {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue( c0(++$j).($i) , '' )
            ->setCellValue( c0(++$j).($i) , utf8_encode($row['distrito']) )
            ...
            ->setCellValue( c0(++$j).($i) , utf8_encode($row['distrito']) )
            ->setCellValue( c0(++$j).($i) , '' )
            ->setCellValue( c0(++$j).($i) , utf8_encode($row['provincia']) )
            ->setCellValue( c0(++$j).($i) , utf8_encode($row['departamento']) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['referencia'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['fachada'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['producto'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper($row['cantidad']) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['color'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper( utf8_encode($row['tipo_pago']) ))
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['precio'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['costo_envio'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['obsequio'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['estado_observacion'])) )
            ->setCellValue( c0(++$j).($i) , strtoupper(utf8_encode($row['estado_real'])) )            
            ;
        $objPHPExcel->getActiveSheet()
            ->getStyle(c2(1,$j,$i,$i))
            ->applyFromArray($border_style);
